    ...
    <footer className="mt-16 border-t border-border bg-surface-warm">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            <h4 className="font-semibold">{tn('shops')}</h4>
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              <li>
              ...
              <li>
                <Link href="/providers?emirate=Dubai" className="hover:text-primary">
                  {t('footer.shopsInDubai')}
                </Link>
              </li>
              <li>
                <Link href="/providers?emirate=Sharjah" className="hover:text-primary">
                  {t('footer.shopsInSharjah')}
                </Link>
              </li>
              <li>
                <Link href="/providers?emirate=Abu Dhabi" className="hover:text-primary">
                  {t('footer.shopsInAbuDhabi')}
                </Link>
              </li>
              <li>
                <Link href="/providers" className="hover:text-primary">
